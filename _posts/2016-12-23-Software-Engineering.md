...
演化模型是目前主流开发模型，子类：原型，螺旋模型，并发开发模型
  ...
  * #### RUP 和 XP 区别
  RUP 以过程导向，以架构为中心，细化阶段的主要目的就是构造一个可运行的架构原型。RUP适合各种规模项目。
  XP 以人为导向，以代码为中心，编码与设计活动融为一体，弱化了架构概念，并且不包含建模、过程等概念，只适合小团队。
...
* ### 需求定义和验证
  ...
  * #### 需求验证
  1. 原型确认
  2. 需求评审（审查，小组评审，走查，结对编程，同级桌查，轮查，临时评审） -> 见第五章‘软件评审’
